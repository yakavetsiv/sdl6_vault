---
title: "UofT USW Job Evaluation and Salary Bands"
date: 2026-06-06
type: index
status: current
...
```mermaid
flowchart TD
    A["USW position / job description"] --> B["USW Job Evaluation"]
    B --> C["Job class / rating / total points"]
    C --> D["PSG / Pay Scale Group"]
    D --> E["USW Salary Grid"]
    E --> F["Hire rate + Steps 01-08"]
    G["Collective Agreement"] --> B
    G --> E
    H["JDX/JDXpert + MSS"] --> B
```
